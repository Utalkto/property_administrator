...
class Expenses(models.Model):
    # foreign keys
    unit = models.ForeignKey(Units, default = None, null=True, blank=False ,on_delete=models.CASCADE)
    categories = models.ForeignKey(Categories, default='', null=False, blank=False ,on_delete=models.CASCADE)
    supplier = models.ForeignKey(Suppliers, default=None, null=True, blank=False ,on_delete=models.CASCADE)
